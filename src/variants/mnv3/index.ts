/**
 * @pixagram/nsfw-lite/mnv3 — MobileNetV3-small-050 variant.
 *
 * Fast on-device binary (sfw / nsfw) image classification for the browser,
 * powered by a MobileNetV3-small-050 backbone via onnxruntime-web. Runs off-thread in a
 * Web Worker (the sibling dist/mnv3/worker.js) with an automatic main-thread
